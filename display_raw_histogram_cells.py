...
def display_raw_histogram(G_FL_filename,SS_filename):
    ...
    labels_g = detect_cells_cyclops5(im_g,41,-5,1000)
...
if __name__=='__main__':
    ...
    file_gfl=r"W:\raspberrypi\photos\Beta\B009\2025-01-24\s025_2\img_WBC_green_FLG_fov25.tiff"
    file_gdf=r"W:\raspberrypi\photos\Beta\B009\2025-01-24\s025_2\img_WBC_red_FLR_fov25.tiff"
    ...
    mean_cell_intensity = np.mean(xHist*yHist)/np.mean(yHist)
    print(f'Mean Cell intensity : {mean_cell_intensity}')
    ...
    peaks, _ = signal.find_peaks(yHist,distance=100)
    ...
    print(f'Peak Intensity {meanInt} with Frequency of {meanFreq} and peak width of {peakWidth}')
