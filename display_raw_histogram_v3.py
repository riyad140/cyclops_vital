...
if __name__=='__main__':
    ...
    signalFilenames_=[
        r"C:\Users\imrul\Downloads\smartExpsosure\run00\img_EXP_blank_BF_fov1.tiff",
        r"C:\Users\imrul\Downloads\smartExpsosure\run00\img_EXP_blank_BF_fov2.tiff",
        r"C:\Users\imrul\Downloads\smartExpsosure\run00\img_EXP_blank_BF_fov3.tiff"
    ...
    targetIntensity = 400  # 400 for DF-BG 550 for FL [300,150,120]
    
    gainOptimum = (targetIntensity - intercept)/slope
    
    print(f"To achieve target intensity of {targetIntensity} required gain {gainOptimum}")
