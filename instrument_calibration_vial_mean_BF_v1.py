...
if __name__=='__main__':
    ...
    folderName = r"W:\raspberrypi\photos\FAT_Captures\Beta\Unit-11\2025-02-13\betaFATv2B_run2"
    analysisFolder = date + '_mean_BF_LED_Calibration'
    crop = True
    cropWindow = 1500
    targetY = 500  # target intensity for calibrated LED BF
    ...
    for fovCount in fovsToAnalyze:
        ...
        signalFilenames = ["img_FAT_ronchi200_blank_BF_ledPWR_100.tiff","img_FAT_ronchi200_blank_BF_ledPWR_200.tiff","img_FAT_ronchi200_blank_BF_ledPWR_300.tiff"]
