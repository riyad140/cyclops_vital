...
if __name__=='__main__':
    ...
    folderName = r"Z:\raspberrypi\photos\FAT_Captures\Alpha_sharp\Cyc7_AS_1\2024-04-03\FAT_brightness_calibration_Cyc7-AS-1_GLASS_FATv8a_run02_LEDPWR_1000"
    date = "20240502"
    crop = True
    cropWindow = 1500
    ...
    for fovCount in fovsToAnalyze:
        probeFilenames=[ f"img_green_FLG_fov{fovCount}_intensityB_500.tiff",f"img_green_FLG_fov{fovCount}_intensityB_750.tiff",f"img_green_FLG_fov{fovCount}_intensityB_1000.tiff"]
