...
for filename in os.listdir(binPath):
    if filename.endswith('.png'):
        if filename.find('31-190')>-1 or filename.find('31-191')>-1:
            print(filename)
...
#%%            
im=cv2.imread(r"G:\Shared drives\Experimental Results\CBC\Data\20200731-MARSDEN-USAF1951\20200731-184215-oneshot-autofocus-25000.png")   
im_crop=im[im.shape[0]*1//3:im.shape[0]*2//3,im.shape[1]*1//3:im.shape[1]*2//3]     
edge_strength=fm_lape(im_crop)