...
def selective_average_image(src_path,key):
    ...
    # helps to average images in a directory while multiple types of captures are present
    print(key)
    filepaths=[]
...
#%%
src_path=r'G:\Shared drives\Engineering\Optics_Sensing_Imaging\CC-Cyclops\Imrul_python_script_ISP\image_repo\2021-01-26_SensorCharacterization\imx258\20220128_IMX258_USAF_run000\bmps'
