...
if __name__=='__main__':
    ...
    folderName = r"Z:\raspberrypi\photos\FAT_Captures\Alpha_sharp\Cyc7_AS_1\2024-04-29\cycImagesFAT"
    date = "20240430"
    crop = True
    cropWindow = 1500
    ...
    for fovCount in fovsToAnalyze:
        ...
        signalFilenames = ["img_FAT_beads_blank_BF_ledPWR_100.tiff","img_FAT_beads_blank_BF_ledPWR_200.tiff","img_FAT_beads_blank_BF_ledPWR_300.tiff"]
