...
def plot_labeled_populations(data, x_channel, y_channel, gate_labels, save_path):
    ...
    label_colors = {
        ...
        gate_labels[2]: 'green',
        gate_labels[3]: 'blue'  # Color for the rest of the population
    }
...
if __name__ == "__main__":
    ...
    file_paths= [
        ...
        r"W:\raspberrypi\photos\PV_2025\B009\2025-03-11\S048_MC\wbc-results-20250311_131518-3part_flagging_nogating\S048-fcs.fcs"  
