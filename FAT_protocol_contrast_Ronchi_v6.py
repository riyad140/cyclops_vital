...
key='dionysus-channel_G_FL-FOV_0_vcm_offset_0_0'  #filename
n=5
rotation_angle=19.7
...
con_map=result[:,0].reshape(n,n).T  # the previous verstion had error
pdr_map=result[:,1].reshape(n,n).T

plt.figure()
plt.imshow(con_map,cmap='jet_r',vmin=35,vmax=60)  # 55-80 for G_BF 35-60 for G_FL
plt.colorbar()
