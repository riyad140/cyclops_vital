...
if __name__=='__main__':
    ...
    folderName = r"W:\raspberrypi\photos\FAT_Captures\Alpha_sharp\Cyc7_AS1\2024-04-29\cycImagesFAT"
    date = "20241008"
    crop = True
    cropWindow = 1500
    ...
    for fovCount in fovsToAnalyze:
        probeFilenames=[f"img_FAT_beads_green_FLG_ledPWR_250.tiff", f"img_FAT_beads_green_FLG_ledPWR_500.tiff",f"img_FAT_beads_green_FLG_ledPWR_750.tiff",f"img_FAT_beads_green_FLG_ledPWR_1000.tiff"]
