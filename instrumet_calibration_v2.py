...
def histogram_analysis(xHist,yHist,figTitle='gg'):
    ...
    peaks, _ = signal.find_peaks(yHist1,prominence=7,distance=100)
    print(peaks)
...
if __name__=='__main__':
    ...
    folderName = r"Z:\raspberrypi\photos\FAT_Captures\Alpha_Plus\Instrument_Calibration\2024-03-21\A14_brightness_calibration_run01"
    date = "20240321"
    crop = True
    cropWindow = 1500
    ...
    for fovCount in fovsToAnalyze:
        probeFilenames=[f"img_EXP_green_FLG_fov1.tiff", f"img_EXP_green_FLG_fov2.tiff",f"img_EXP_green_FLG_fov3.tiff",f"img_EXP_green_FLG_fov4.tiff"]
        signalFilenames =[f"img_EXP_blue_DF_fov1.tiff",f"img_EXP_blue_DF_fov2.tiff",f"img_EXP_blue_DF_fov3.tiff",f"img_EXP_blue_DF_fov4.tiff"]
        #probeFilenames
        #probeFilenames
