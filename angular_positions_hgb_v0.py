...
#%%
Angular_positions_final=np.hstack((np.array(Angular_positions_0),np.array(Angular_positions_1),np.array(Angular_positions_2),np.array(Angular_positions_3)))
Angular_positions_final=Angular_positions_final*10
print(Angular_positions_final)

Angular_positions=np.round(Angular_positions_final)
