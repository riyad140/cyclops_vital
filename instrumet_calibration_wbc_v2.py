...
if __name__=='__main__':
    ...
    folderName = r"Z:\raspberrypi\photos\FAT_Captures\Alpha_Plus\Instrument_Calibration\2024-01-31\FAT_brightness_calibration_Cyc7-A10_ps_beads_WBC_run000_LRV2"
    date = "20240603_bc25"
    crop = True
    cropWindow = 1500
    ...
    for fovCount in fovsToAnalyze:
        ...
        # signalFilenames = [f"img_green_FLG_fov{fovCount}_intensityB_250.tiff",f"img_green_FLG_fov{fovCount}_intensityB_500.tiff",f"img_green_FLG_fov{fovCount}_intensityB_750.tiff",f"img_green_FLG_fov{fovCount}_intensityB_1000.tiff"]
        signalFilenames = [f"img_blue_DF_fov{fovCount}_intensityB_250.tiff",f"img_blue_DF_fov{fovCount}_intensityB_500.tiff",f"img_blue_DF_fov{fovCount}_intensityB_750.tiff",f"img_blue_DF_fov{fovCount}_intensityB_1000.tiff"]
        #img_green_FLG_fov1_intensityB_250, img_blue_DF_fov2_intensityB_250
...
#%
    ...
    #%% Equalized DAC
    targetY = 70
    m = 0.019  #slopeMedian#0.342
    c = 48.5     #interceptMedian #140.1
